...
{
    this->mylayout->setContentsMargins(left, top, right, bottom);
}

// 设置控件之间的间距
void TitleBar::setSpacing(int value)
{
    this->mylayout->setSpacing(value);
}
...
void TitleBar::loadStyleSheet(const QString &sheetPath)
{
